  ...
  return (
    <div className="min-h-screen grid place-items-center px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm bg-surface border border-line rounded-xl p-8">
        ...
        <p className="text-muted text-sm mb-6">Set up sending in a couple minutes.</p>
        ...
        {notice && (
          <div className="mb-4 text-sm text-sent bg-sent/10 border border-sent/30 rounded-md px-3 py-2">
            {notice}
          </div>
        )}
